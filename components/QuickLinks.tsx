  ...
  return (
    <section id="quick-links-section" className="py-12 px-4 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Quick Links Grid - Responsive layout */}
          ...
          {sections.map((section, index) => (
            <button
              ...
              className={`group relative bg-gradient-to-br from-gray-900 to-black border-2 border-gray-800 hover:border-brand-orange rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-brand-orange/20 ${
                // Make last item span 2 columns on mobile only if there's an odd number
                index === sections.length - 1 && sections.length % 2 !== 0 ? 'md:col-span-1' : ''
              }`}
            >
              {/* Icon */}
